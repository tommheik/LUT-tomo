function [ W ] = create_spot_operator_2d_fanbeam_cpu(n, SOD, ODD, detPixelSize, nDetectors, angles)
%CREATE_SPOT_OPERATOR_2D_FANBEAM_CPU Create ASTRA Spot operator (CPU)
%   W = create_spot_operator_2d_fanbeam_cpu(n, SOD, ODD, detPixelSize, 
...
%   using a flat detector and a CPU-based projector. The parameters 
...
% Other projector types include 'line_fanflat', but this seems to produce
% more artefacts in the projections and backprojections. From experience,
% 'strip_fanflat' is the best option
W = opTomo('strip_fanflat', projGeom, volGeom);
end
